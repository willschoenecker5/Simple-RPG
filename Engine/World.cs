...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateLocations()
        {
            ...
            Vendor toughLookingGuard = new Vendor("Tough Looking Guard");
            toughLookingGuard.AddItemToInventory(ItemByID(ITEM_ID_CLUB), 1);
            guardPost.VendorWorkingHere = toughLookingGuard;
