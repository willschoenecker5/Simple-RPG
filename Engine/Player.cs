...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public static Player CreatePlayerFromXmlString (string xmlPlayerData)
        {
            ...
            {
                // If there was an error loading the player XML data create the default player
        ...
        public string ToXmlString()
        {
            ...
            // Create the "Stats" child node to hold the player statistics nodes
        ...
        public void RemoveItemFromInventory(Item itemToRemove, int quantity = 1)
        {
            ...
            if (item == null)
            {
                ...
                throw new ArgumentException("Item must be in player inventory", nameof(item));
            }
            else
            {
                ...
                {
                    item.Quantity = 0;
                    throw new ArgumentException("Item cannot be negative", nameof(item));
                }
        ...
        public void MoveTo(Location newLocation)
        {
            ...
            {
                RaiseMessage("You must have a " + newLocation.ItemRequiredToEnter.Name + " to enter this location." + Environment.NewLine);
                return;
            }
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            RaiseMessage("You complete the '" + newLocation.QuestAvailableHere.Name + "' quest." + Environment.NewLine);
